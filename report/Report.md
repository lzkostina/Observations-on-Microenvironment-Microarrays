...
![Missing values mean count across staining sets.](image_1.png)
...
![Correlation Between Missing Data and COL1 Value in ECM-related Features.](image_2.png)
...
![Distribution of Nuclei Area within Wells of Plate 31.](kde_area_well.png)

![Distribution of Nuclei Area across Staining Sets.](kde_area_sets.png)
...
![Distribution of Spot Cell Count within Wells of Plate 31, Staining Set 2.](kde_count_well.png)

![Distribution of Spot Cell Count within Wells of Plate 13, Staining Set 3.](kde_cell_well_2.png)

![Distribution of Spot Cell Count across Staining Sets.](kde_cell_sets.png)
...
![Cell Count Difference for Plate 30 Well 2.](spot.png)
...
![Histograms of Nuclei Area per Staining Set.](disparity_area.png)

![Histograms of Cell Count per Staining Set.](disparity_cell.png)
...
![Scatterplots for Mean Control Cell Counts and Treatment Cell Counts per Plate, split by Staining Set.](control_correlation_plot_split.png)
...
![Left: Boxplot for Control Cell Counts for ECMP=VTN on Staining Set 2, Right: Boxplot for Cell Counts per well in Plate 31 (in Staining Set 2).](control_variance1.png)
